...
import com.example.piggybank.ParentActivities.TransactionDetailsParentActivity;
...
public class TransactionsChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transactions_child);
        ...
        //setup recyclerview
        recyclerView = findViewById(R.id.transactionsRVChildList);
    ...
    public void openCreateTaskActivity(View view) {
        Intent intent = new Intent(TransactionsChildActivity.this, RequestTransactionActivity.class);
    ...
    public void makeRV() {
        ...
        get.getTransactionsByChildId(childId, new OnSuccessListener<ArrayList<Transaction>>() {
            ...
            public void onSuccess(ArrayList<Transaction> transactions) {
                TextView text = findViewById(R.id.noTransactionsChild2);
