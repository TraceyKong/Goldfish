...
public class WishListParentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wish_list_parent);
    ...
    public void makeRV() {
        ...
        get.getWishListItemsByChildId(childId, new OnSuccessListener<ArrayList<WishListItem>>() {
            ...
            public void onSuccess(ArrayList<WishListItem> items) {
                TextView text = findViewById(R.id.noWishListItems2);
        ...
        public void onBindViewHolder(@NonNull ItemHolder holder, int position) {
            ...
            holder.layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(WishListParentActivity.this, WishListItemDetailsParentActivity.class);
